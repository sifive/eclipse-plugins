 ...
 */
public class WorkspaceHwBreakpointLimitPage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	// ------------------------------------------------------------------------

	public static final String ID = "ilg.gnumcueclipse.debug.gdbjtag.workspaceHwBreakpointLimitPage";

	// ------------------------------------------------------------------------

	public WorkspaceHwBreakpointLimitPage() {
		super(GRID);
		...
		setDescription(PersistentPreferences.subTokens(Messages.WorkspaceHwBreakpointLimitPagePropertyPage_description));
	}
